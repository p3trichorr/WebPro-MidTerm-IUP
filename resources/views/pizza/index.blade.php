            ...
            <div class="card">
                <div class="card-header">{{ __('All Pizza') }}
                    <a href="{{route('pizza.create')}}">
                        <button class="btn btn-success" style="float: right">Add a Pizza</button>
                    </a>
                </div>
                            ...
                            <tr>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">A pizza is going to be killed here</h5>
                                        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        Are you sure? What about his/her family?
                                    </div>
