...
class PizzaController extends Controller
{
    ...
    public function store(PizzaStoreRequest $request)
    {
        ...
        return redirect()->route('pizza.index')->with('message','A new pizza is born!');
    }
    ...
    public function update(PizzaUpdateRequest $request, $id)
    {
        ...
        $pizza->image = $path;
        $pizza->save();
        return redirect()->route('pizza.index')->with('message','A pizza got new credentials!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pizza.index')->with('message','A moment of silence to our fallen pizza');
    }
}
